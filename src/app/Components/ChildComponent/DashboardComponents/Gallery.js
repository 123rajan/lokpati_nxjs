...
const Gallery = ({ handleGalleryUpload, handleCancel }) => {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center h-screen bg-[#100a5e] from-emerald-500 to-teal-500 text-red-100">
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="w-full bg-[#100a5e] from-emerald-500 to-teal-500 text-white p-4 sm:p-8 space-y-8">

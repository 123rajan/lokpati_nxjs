            ...
            {loadingNews ? (
              ...
              <>
                {filteredNews.slice(0, itemsToShow).map((item) => (
                  ...
                  //       }
                  //     >
                  //       <h2 className="font-mukta text-2xl font-bold line-clamp-2 sm:w-[90%] hover:text-blue-700 cursor-pointer">
                  //         {item.news_title}
                  //       </h2>
                  //     </Link>
                  //   </span>
                ...
                <div className="w-full flex justify-end">
                  {itemsToShow < filteredNews.length && (
                    <button
                      className="mt-4 p-2 bg-blue-500 text-white rounded hover:bg-blue-600 w-full font-bold"

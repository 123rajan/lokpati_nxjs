...
const Gallery = () => {
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center h-screen bg-blue-900 text-red-500">
        {error}
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-blue-900 text-white p-4 sm:p-8">
      <h1 className="text-4xl font-bold mb-8 text-center">Image Gallery</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
        {displayedImages.map((image) => (
          <div
            key={image.id}
            className="bg-blue-800 rounded-lg shadow-lg overflow-hidden transform transition duration-300 hover:scale-105"
          >
            ...
            <div className="p-4">
              ...
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition duration-300 ease-in-out flex items-center justify-center"
              >
      ...
      {displayedImages.length < images.length && (
        <div className="mt-8 flex justify-center">
          <button
            onClick={loadMore}
            className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-full transition duration-300 ease-in-out flex items-center justify-center text-lg"
          >

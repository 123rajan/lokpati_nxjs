        ...
        <div className="flex w-full h-full  flex-col">
          <div className="w-full overflow-hidden  relative group">
            ...
            <Image
              ...
              height={180} // Set height based on your design
              className="w-full h-[180px] group-hover:opacity-80 group-hover:scale-110 duration-150 "
          ...
          <div className="w-full flex flex-col justify-start gap-[8px] mt-5">
            <h2
              className={`${
                textBlack ? "text-[rgba(0,0,0,0.8)]" : "text-white"
              } text-2xl w-full px-[4px] line-clamp-${lineClampTitle}`}
              style={{
                lineHeight: "1.5",
                fontWeight: "bold",
                wordWrap: "break-word", // Ensures long words break onto the next line
                overflowWrap: "break-word", // Handles overflow breaking for long words
              }}
            >
              {title}
            </h2>
